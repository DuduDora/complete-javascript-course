...
console.log(averageDolphins); // 46, 60 
const averageKoalas = calcAverage(23, 34, 27);
console.log(averageKoalas); // 56, 28

function checkWinner(averageDolphins, averageKoalas) {
    const winner = averageDolphins >= 2 * averageKoalas ?
...
//* Dado dos strings, escribe una function
//para determinar si el  segundo string es un anagrama de el primero.
//* Deberia retornar true si cada letra en el primer string se encuentra
// en el segundo string.
//* Un anagrama consiste en crear una palabra a partir de
//la reordenación de las letras de otra palabra.
//* Ejemplo: cinema y iceman.
